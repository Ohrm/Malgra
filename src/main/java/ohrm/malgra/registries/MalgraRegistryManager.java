...
public final class MalgraRegistryManager {
    ...
    public static void CreateRegistries(){
        researchRegistry = new RegistryBuilder().setType(Research.class).setName(new ResourceLocation(Reference.MODID, "malgraResearchRegistry")).setIDRange(0, 4096).create();
    }
